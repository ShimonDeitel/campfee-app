...
struct ContentView: View {
    ...
    private var emptyState: some View {
        VStack(spacing: 12) {
            ...
            Text("Tap + to log your first stay.")
                .font(Theme.captionFont)
                .foregroundStyle(.secondary)
        }
    ...
    private func row(for entry: StayEntry) -> some View {
        HStack {
...
struct EntryEditView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(existingId == nil ? "Add Stay" : "Edit Stay")
            .toolbar {
